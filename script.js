...
(async function init() {
    ...
    if (savedUser) {
        try {
            ...
            if (currentUser.id) {
                // RE-FETCH member data to get latest from Google Sheets
                console.log('Re-fetching member data for saved user:', currentUser.id);
                try {
                    ...
                    if (memberResponse.ok) {
                        ...
                        console.log('Fresh member data:', memberData);
                        
                        // Update profile with fresh data
                        currentUser.profile = {
                            name: memberData.name || currentUser.name,
                            email: memberData.email || 'Not set',
                            department: memberData.department || 'Not set',
